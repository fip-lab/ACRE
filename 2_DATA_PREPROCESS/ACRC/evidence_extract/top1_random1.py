...
source_path = '/disk2/huanggj/ACMRC_EXPERIMENT/dataset/ACRC/new_data_0504/acrc_test_rebalance.json'
des_path = '/disk2/huanggj/ACMRC_EXPERIMENT/dataset/ACRC/top1_random/acrc_test.json'
